        ...
        <div className="text-mainTextColor container mx-auto mt-32">
          ...
          <div className='flex flex-wrap justify-center w-full'>
            ...
            {Array.isArray(tours.data) && tours.data.slice(0, 4).map((tour: Tour) =>
              <div key={tour.id} className='w-full md:w-1/2 lg:w-1/4 p-2 cursor-pointer transform transition-transform duration-300 hover:scale-105'>
