...
export default function TopTrending() {
  ...
  return (
<div className="bg-bgTranding m-auto py-20 px-5 shadow-lg rounded-lg">
  <div className="m-auto px-5 md:px-20">
    ...
    <div className="flex w-full gap-5 py-4 px-2 flex-col sm:flex-row sm:flex-wrap md:flex-nowrap">
      <div className="flex-none sm:w-full md:w-1/4">
        <Card
