...
import BannerImage from "../../assets/BannerFrameImage.png";
...
<section className="app-banner px-4 sm:px-6 lg:px-8">
  ...
  <div className="relative text-white rounded-2xl w-full sm:z-50 md:w-[80%] lg:w-[50%] max-w-4xl p-6 sm:p-10 md:p-12 z-10">
